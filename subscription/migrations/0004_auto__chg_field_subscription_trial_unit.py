...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subscription.trial_unit'
        db.alter_column('subscription_subscription', 'trial_unit', self.gf('django.db.models.fields.CharField')(default='', max_length=1))

    def backwards(self, orm):

        # Changing field 'Subscription.trial_unit'
        db.alter_column('subscription_subscription', 'trial_unit', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        'subscription.subscription': {
            ...
            'trial_unit': ('django.db.models.fields.CharField', [], {'max_length': '1', 'blank': 'True'})
        },
